-- Add ai_creator_helper_bot_count column to usage_tracking table
ALTER TABLE public.usage_tracking 
ADD COLUMN IF NOT EXISTS ai_creator_helper_bot_count integer NOT NULL DEFAULT 0;

-- Update reset_daily_usage function to include new column
...
-- Update manual_reset_user_usage function to include new column
